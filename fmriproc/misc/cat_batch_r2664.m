...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.WMHtpm = {'CHANGE_THIS_SPM_PATH/toolbox/cat12/templates_MNI152NLin2009cAsym/cat_wmh_miccai2017.nii'};
matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.BVtpm = {'CHANGE_THIS_SPM_PATH/toolbox/cat12/templates_MNI152NLin2009cAsym/cat_bloodvessels.nii'};
matlabbatch{1}.spm.tools.cat.estwrite.extopts.segmentation.SLtpm = {'CHANGE_THIS_SPM_PATH/toolbox/cat12/templates_MNI152NLin2009cAsym/cat_strokelesions_ATLAS303.nii'};
