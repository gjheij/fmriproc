...
sys.path.insert(0, os.path.abspath("../.."))  # Ensure parent directory is included
try:
...
MOCK_MODULES = [
    "nibabel", "nipype", "nipype.interfaces", "nipype.interfaces.freesurfer", "lazyfmri",
    "pandas", "joblib",
]
...
project = "fMRIproc Documentation"
author = "Jurjen Heij"
release = "1.0"
